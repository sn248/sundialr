...
Prior to version 0.2.0 an event at $t = 0$ _replaced_ the initial condition rather than adding to it, so the same value meant different things at $t = 0$ and at later times. Solutions that dose at time zero therefore differ from earlier versions by the initial condition.
