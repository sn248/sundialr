...
char* ARKodeGetReturnFlagName(long int flag)
{
  ...
  switch (flag)
  {
  case ARK_SUCCESS: strcpy(name, "ARK_SUCCESS"); break;
  case ARK_TSTOP_RETURN: strcpy(name, "ARK_TSTOP_RETURN"); break;
  case ARK_ROOT_RETURN: strcpy(name, "ARK_ROOT_RETURN"); break;
  case ARK_WARNING: strcpy(name, "ARK_WARNING"); break;
  case ARK_TOO_MUCH_WORK: strcpy(name, "ARK_TOO_MUCH_WORK"); break;
  case ARK_TOO_MUCH_ACC: strcpy(name, "ARK_TOO_MUCH_ACC"); break;
  case ARK_ERR_FAILURE: strcpy(name, "ARK_ERR_FAILURE"); break;
  case ARK_CONV_FAILURE: strcpy(name, "ARK_CONV_FAILURE"); break;
  case ARK_LINIT_FAIL: strcpy(name, "ARK_LINIT_FAIL"); break;
  case ARK_LSETUP_FAIL: strcpy(name, "ARK_LSETUP_FAIL"); break;
  case ARK_LSOLVE_FAIL: strcpy(name, "ARK_LSOLVE_FAIL"); break;
  case ARK_RHSFUNC_FAIL: strcpy(name, "ARK_RHSFUNC_FAIL"); break;
  case ARK_FIRST_RHSFUNC_ERR: strcpy(name, "ARK_FIRST_RHSFUNC_ERR"); break;
  case ARK_REPTD_RHSFUNC_ERR: strcpy(name, "ARK_REPTD_RHSFUNC_ERR"); break;
  case ARK_UNREC_RHSFUNC_ERR: strcpy(name, "ARK_UNREC_RHSFUNC_ERR"); break;
  case ARK_RTFUNC_FAIL: strcpy(name, "ARK_RTFUNC_FAIL"); break;
  case ARK_LFREE_FAIL: strcpy(name, "ARK_LFREE_FAIL"); break;
  case ARK_MASSINIT_FAIL: strcpy(name, "ARK_MASSINIT_FAIL"); break;
  case ARK_MASSSETUP_FAIL: strcpy(name, "ARK_MASSSETUP_FAIL"); break;
  case ARK_MASSSOLVE_FAIL: strcpy(name, "ARK_MASSSOLVE_FAIL"); break;
  case ARK_MASSFREE_FAIL: strcpy(name, "ARK_MASSFREE_FAIL"); break;
  case ARK_MASSMULT_FAIL: strcpy(name, "ARK_MASSMULT_FAIL"); break;
  case ARK_CONSTR_FAIL: strcpy(name, "ARK_CONSTR_FAIL"); break;
  case ARK_MEM_FAIL: strcpy(name, "ARK_MEM_FAIL"); break;
  case ARK_MEM_NULL: strcpy(name, "ARK_MEM_NULL"); break;
  case ARK_ILL_INPUT: strcpy(name, "ARK_ILL_INPUT"); break;
  case ARK_NO_MALLOC: strcpy(name, "ARK_NO_MALLOC"); break;
  case ARK_BAD_K: strcpy(name, "ARK_BAD_K"); break;
  case ARK_BAD_T: strcpy(name, "ARK_BAD_T"); break;
  case ARK_BAD_DKY: strcpy(name, "ARK_BAD_DKY"); break;
  case ARK_TOO_CLOSE: strcpy(name, "ARK_TOO_CLOSE"); break;
  case ARK_VECTOROP_ERR: strcpy(name, "ARK_VECTOROP_ERR"); break;
  case ARK_NLS_INIT_FAIL: strcpy(name, "ARK_NLS_INIT_FAIL"); break;
  case ARK_NLS_SETUP_FAIL: strcpy(name, "ARK_NLS_SETUP_FAIL"); break;
  case ARK_NLS_SETUP_RECVR: strcpy(name, "ARK_NLS_SETUP_RECVR"); break;
  case ARK_NLS_OP_ERR: strcpy(name, "ARK_NLS_OP_ERR"); break;
  case ARK_INNERSTEP_ATTACH_ERR:
    strcpy(name, "ARK_INNERSTEP_ATTACH_ERR");
    break;
  case ARK_INNERSTEP_FAIL: strcpy(name, "ARK_INNERSTEP_FAIL"); break;
  case ARK_OUTERTOINNER_FAIL: strcpy(name, "ARK_OUTERTOINNER_FAIL"); break;
  case ARK_INNERTOOUTER_FAIL: strcpy(name, "ARK_INNERTOOUTER_FAIL"); break;
  case ARK_POSTPROCESS_STEP_FAIL:
    strcpy(name, "ARK_POSTPROCESS_STEP_FAIL");
    break;
  case ARK_POSTPROCESS_STAGE_FAIL:
    strcpy(name, "ARK_POSTPROCESS_STAGE_FAIL");
    break;
  case ARK_USER_PREDICT_FAIL: strcpy(name, "ARK_USER_PREDICT_FAIL"); break;
  case ARK_INTERP_FAIL: strcpy(name, "ARK_INTERP_FAIL"); break;
  case ARK_INVALID_TABLE: strcpy(name, "ARK_INVALID_TABLE"); break;
  case ARK_CONTEXT_ERR: strcpy(name, "ARK_CONTEXT_ERR"); break;
  case ARK_RELAX_FAIL: strcpy(name, "ARK_RELAX_FAIL"); break;
  case ARK_RELAX_MEM_NULL: strcpy(name, "ARK_RELAX_MEM_NULL"); break;
  case ARK_RELAX_FUNC_FAIL: strcpy(name, "ARK_RELAX_FUNC_FAIL"); break;
  case ARK_RELAX_JAC_FAIL: strcpy(name, "ARK_RELAX_JAC_FAIL"); break;
  case ARK_CONTROLLER_ERR: strcpy(name, "ARK_CONTROLLER_ERR"); break;
  case ARK_STEPPER_UNSUPPORTED: strcpy(name, "ARK_STEPPER_UNSUPPORTED"); break;
  case ARK_ADJ_RECOMPUTE_FAIL: strcpy(name, "ARK_ADJ_RECOMPUTE_FAIL"); break;
  case ARK_ADJ_CHECKPOINT_FAIL: strcpy(name, "ARK_ADJ_CHECKPOINT_FAIL"); break;
  case ARK_SUNADJSTEPPER_ERR: strcpy(name, "ARK_SUNADJSTEPPER_ERR"); break;
  case ARK_DOMEIG_FAIL: strcpy(name, "ARK_DOMEIG_FAIL"); break;
  case ARK_MAX_STAGE_LIMIT_FAIL:
    strcpy(name, "ARK_MAX_STAGE_LIMIT_FAIL");
    break;
  case ARK_SUNSTEPPER_ERR: strcpy(name, "ARK_SUNSTEPPER_ERR"); break;
  case ARK_STEP_DIRECTION_ERR: strcpy(name, "ARK_STEP_DIRECTION_ERR"); break;
  case ARK_UNRECOGNIZED_ERROR: strcpy(name, "ARK_UNRECOGNIZED_ERROR"); break;
