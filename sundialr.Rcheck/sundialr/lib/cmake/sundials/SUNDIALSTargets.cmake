...
# Create imported target SUNDIALS::sunnonlinsolauto_static
add_library(SUNDIALS::sunnonlinsolauto_static STATIC IMPORTED)

set_target_properties(SUNDIALS::sunnonlinsolauto_static PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "SUNDIALS_STATIC_DEFINE"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:-lm>;SUNDIALS::core_static;SUNDIALS::sunnonlinsolnewton_static;SUNDIALS::sunnonlinsolfixedpoint_static"
)
