...
# Import target "SUNDIALS::sunnonlinsolauto_static" for configuration "Release"
set_property(TARGET SUNDIALS::sunnonlinsolauto_static APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(SUNDIALS::sunnonlinsolauto_static PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libsundials_sunnonlinsolauto.a"
  )

list(APPEND _cmake_import_check_targets SUNDIALS::sunnonlinsolauto_static )
list(APPEND _cmake_import_check_files_for_SUNDIALS::sunnonlinsolauto_static "${_IMPORT_PREFIX}/lib/libsundials_sunnonlinsolauto.a" )
