...
char* IDAGetReturnFlagName(long int flag)
{
  ...
  case IDA_NO_SENS: strcpy(name, "IDA_NO_SENS"); break;
  case IDA_SRES_FAIL: strcpy(name, "IDA_SRES_FAIL"); break;
  case IDA_REP_SRES_ERR: strcpy(name, "IDA_REP_SRES_ERR"); break;
  case IDA_BAD_IS: strcpy(name, "IDA_BAD_IS"); break;
  case IDA_NO_QUAD: strcpy(name, "IDA_NO_QUAD"); break;
  case IDA_NO_QUADSENS: strcpy(name, "IDA_NO_QUADSENS"); break;
  case IDA_QRHS_FAIL: strcpy(name, "IDA_QRHS_FAIL"); break;
  case IDA_REP_QRHS_ERR: strcpy(name, "IDA_REP_QRHS_ERR"); break;
  case IDA_QSRHS_FAIL: strcpy(name, "IDA_QSRHS_FAIL"); break;
  case IDA_REP_QSRHS_ERR:
    strcpy(name, "IDA_REP_QSRHS_ERR");
    break;

    /* IDAA flags follow below. */
  case IDA_NO_ADJ: strcpy(name, "IDA_NO_ADJ"); break;
  case IDA_BAD_TB0: strcpy(name, "IDA_BAD_TB0"); break;
  case IDA_REIFWD_FAIL: strcpy(name, "IDA_REIFWD_FAIL"); break;
  case IDA_FWD_FAIL: strcpy(name, "IDA_FWD_FAIL"); break;
  case IDA_GETY_BADT: strcpy(name, "IDA_GETY_BADT"); break;
  case IDA_NO_BCK: strcpy(name, "IDA_NO_BCK"); break;
  case IDA_NO_FWD: strcpy(name, "IDA_NO_FWD"); break;
