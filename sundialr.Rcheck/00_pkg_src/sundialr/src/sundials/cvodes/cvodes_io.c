...
char* CVodeGetReturnFlagName(long int flag)
{
  ...
  switch (flag)
  {
  case CV_SUCCESS: strcpy(name, "CV_SUCCESS"); break;
  case CV_TSTOP_RETURN: strcpy(name, "CV_TSTOP_RETURN"); break;
  case CV_ROOT_RETURN: strcpy(name, "CV_ROOT_RETURN"); break;
  case CV_TOO_MUCH_WORK: strcpy(name, "CV_TOO_MUCH_WORK"); break;
  case CV_TOO_MUCH_ACC: strcpy(name, "CV_TOO_MUCH_ACC"); break;
  case CV_ERR_FAILURE: strcpy(name, "CV_ERR_FAILURE"); break;
  case CV_CONV_FAILURE: strcpy(name, "CV_CONV_FAILURE"); break;
  case CV_LINIT_FAIL: strcpy(name, "CV_LINIT_FAIL"); break;
  case CV_LSETUP_FAIL: strcpy(name, "CV_LSETUP_FAIL"); break;
  case CV_LSOLVE_FAIL: strcpy(name, "CV_LSOLVE_FAIL"); break;
  case CV_RHSFUNC_FAIL: strcpy(name, "CV_RHSFUNC_FAIL"); break;
  case CV_FIRST_RHSFUNC_ERR: strcpy(name, "CV_FIRST_RHSFUNC_ERR"); break;
  case CV_REPTD_RHSFUNC_ERR: strcpy(name, "CV_REPTD_RHSFUNC_ERR"); break;
  case CV_UNREC_RHSFUNC_ERR: strcpy(name, "CV_UNREC_RHSFUNC_ERR"); break;
  case CV_RTFUNC_FAIL: strcpy(name, "CV_RTFUNC_FAIL"); break;
  case CV_MEM_FAIL: strcpy(name, "CV_MEM_FAIL"); break;
  case CV_MEM_NULL: strcpy(name, "CV_MEM_NULL"); break;
  case CV_ILL_INPUT: strcpy(name, "CV_ILL_INPUT"); break;
  case CV_NO_MALLOC: strcpy(name, "CV_NO_MALLOC"); break;
  case CV_BAD_K: strcpy(name, "CV_BAD_K"); break;
  case CV_BAD_T: strcpy(name, "CV_BAD_T"); break;
  case CV_BAD_DKY: strcpy(name, "CV_BAD_DKY"); break;
  case CV_NO_QUAD: strcpy(name, "CV_NO_QUAD"); break;
  case CV_QRHSFUNC_FAIL: strcpy(name, "CV_QRHSFUNC_FAIL"); break;
  case CV_FIRST_QRHSFUNC_ERR: strcpy(name, "CV_FIRST_QRHSFUNC_ERR"); break;
  case CV_REPTD_QRHSFUNC_ERR: strcpy(name, "CV_REPTD_QRHSFUNC_ERR"); break;
  case CV_UNREC_QRHSFUNC_ERR: strcpy(name, "CV_UNREC_QRHSFUNC_ERR"); break;
  case CV_BAD_IS: strcpy(name, "CV_BAD_IS"); break;
  case CV_NO_SENS: strcpy(name, "CV_NO_SENS"); break;
  case CV_SRHSFUNC_FAIL: strcpy(name, "CV_SRHSFUNC_FAIL"); break;
  case CV_FIRST_SRHSFUNC_ERR: strcpy(name, "CV_FIRST_SRHSFUNC_ERR"); break;
  case CV_REPTD_SRHSFUNC_ERR: strcpy(name, "CV_REPTD_SRHSFUNC_ERR"); break;
  case CV_UNREC_SRHSFUNC_ERR: strcpy(name, "CV_UNREC_SRHSFUNC_ERR"); break;
  case CV_TOO_CLOSE: strcpy(name, "CV_TOO_CLOSE"); break;
  case CV_NLS_INIT_FAIL: strcpy(name, "CV_NLS_INIT_FAIL"); break;
  case CV_NLS_SETUP_FAIL: strcpy(name, "CV_NLS_SETUPT_FAIL"); break;
  case CV_NO_ADJ: strcpy(name, "CV_NO_ADJ"); break;
  case CV_NO_FWD: strcpy(name, "CV_NO_FWD"); break;
  case CV_NO_BCK: strcpy(name, "CV_NO_BCK"); break;
  case CV_BAD_TB0: strcpy(name, "CV_BAD_TB0"); break;
  case CV_REIFWD_FAIL: strcpy(name, "CV_REIFWD_FAIL"); break;
  case CV_FWD_FAIL: strcpy(name, "CV_FWD_FAIL"); break;
  case CV_GETY_BADT: strcpy(name, "CV_GETY_BADT"); break;
  case CV_NLS_FAIL: strcpy(name, "CV_NLS_FAIL"); break;
  case CV_PROJ_MEM_NULL: strcpy(name, "CV_PROJ_MEM_NULL"); break;
  case CV_PROJFUNC_FAIL: strcpy(name, "CV_PROJFUNC_FAIL"); break;
  case CV_REPTD_PROJFUNC_ERR: strcpy(name, "CV_REPTD_PROJFUNC_ERR"); break;
